...
class ChatBot():
    ...
    def setPersonagem(self, id):
        ...
        self.resetChat()
        self.chat.send_message("Responda todas as mensagens como se você fosse "+personagens[id]+". ao ser perguntado quem é você ou perguntas pessoas você irá responder com informações relacionadas ao personagem. responda de forma simples e amigável as mensagens que são recebidas, mantendo as respostas curtas.")
